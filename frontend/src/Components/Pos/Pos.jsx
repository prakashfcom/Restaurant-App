            ...
            <div className="col-sm-7 col-lg-8">
               <div className="division mb-4">
                    <div className="row">
                        ...
                        <div className="col-lg-2">                            
                        <button type="button" className="btn btn-success w-100">Running Order</button>      
                        </div>
                        <div className="col-lg-3">
                        <button type="button" className="btn btn-success w-100">Holding Order</button>      
                        </div>
                        <div className="col-lg-2 mb-0">
                        <button type="button" className="btn btn-success w-100">Today Order</button> 
                        </div>
               ...
               <div className="row">
                <div className="col-12 main-content">
                    ...
                    <li className="nav-item ">
                            <a className="nav-link  active" data-toggle="tab" href="#table" role="tab" aria-controls="kiwi2" aria-selected="false">Table</a>
                        </li>    
                        <li className="nav-item">
                            <a className="nav-link " data-toggle="tab" href="#dinein" role="tab" aria-controls="duck2" aria-selected="true">Dine In</a>
                        </li>
                        <li className="nav-item">
                                        ...
                                        <div className="tab-pane fade show active" id="Coffe" role="tabpanel" aria-labelledby="home-tab">                                          
                                            <div className="row">                                                
                                                <div className="col-sm-3 col-md-3">
                                                    <div className="menu-box">
                                                        <div className="menu-div">
                                                            <img src="assets/images/pos/veg.png" />  
                                                ...
                                                <div className="col-sm-3 col-md-3">
                                                    <div className="menu-box">
                                                        <div className="menu-div">
                                                            <img src="assets/images/pos/non-veg.png" />  
                            ...
                            <div className="row"> 
                                <div className="col-sm-4 col-md-4">
                                    <div className="form-group has-search mb-3">  
                                        <span className="fa fas-search form-control-feedback"></span>
                                        <input type="text" className="form-control" placeholder="Order, Table, waiter search" />
                                    </div>
                                </div>
                                        ...
                                        <div className="tab-pane fade show active" id="main" role="tabpanel" aria-labelledby="home-tab">                                          
                                            <div className="row">                                                
                                                <div className="col-sm-3 col-md-3">
                                                    <div className="menu-box">
                                                        <div className="menu-div">
                                                            <img src="assets/images/pos/table-1.png" /> 
